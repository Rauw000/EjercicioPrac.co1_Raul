...
CREATE TABLE libro (
  ...
  CONSTRAINT n_libro_categoria FOREIGN KEY (categoria_id)
...
INSERT INTO libro (titulo, autor, isbn, descripcion, categoria_id, fecha_publicacion, precio)
VALUES
...
-- 7) Datos de ejemplo: queja/sugerencia
